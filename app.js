function exibirMensagemInicial() {
    ...
    exibirTextoNaTela('p' , 'Escolha um número entre 1 e 25'); //Linha 23 index.html
}
/*
...
function gerarNumeroAleatorio() {
    let numeroEscolhido = parseInt(Math.random() * 25 + 1); // Gera um numero entre 1 e 25 e armazena em numeroEscolhido
